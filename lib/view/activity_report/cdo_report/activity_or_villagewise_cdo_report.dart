...
class ActivityorVillagewiseCDOReport extends StatelessWidget {
  final _controller = Get.put(ActivityorVillageCDOReportController());
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        ...
        Get.toNamed(ROUTE_ACTIVITY_CFA_CDO_REPORT,
            arguments: widget.model!.name);
      },
