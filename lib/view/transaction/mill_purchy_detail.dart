...
class MillPurchyDetails extends StatefulWidget {
  @override
  _MillPurchyDetailsState createState() => _MillPurchyDetailsState();
}

class _MillPurchyDetailsState extends State<MillPurchyDetails> {
